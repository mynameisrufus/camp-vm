class couchdb(
  $download = 'http://apache.mirror.serversaustralia.com.au/couchdb/source/1.4.0/apache-couchdb-1.4.0.tar.gz',
  $cwd = '/usr/local/src',
  $filename = 'apache-couchdb-1.4.0.tar.gz',
  $extension = '.tar.gz',
  $foldername = 'apache-couchdb-1.4.0',
  $buildopts = '',
